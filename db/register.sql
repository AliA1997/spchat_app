INSERT INTO spchat_users (username, email, password, image, age, date_registered, favorite_teams, favorite_players, favorite_sport, verified, verification_link, posts) 
VALUES 
